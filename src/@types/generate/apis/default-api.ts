  ...
  return {
    ...
    getMemberById: async (
      ...
      if (memberId === null || memberId === undefined) {
        throw new RequiredError(
          "memberId",
          "Required parameter memberId was null or undefined when calling getMemberById."
        );
      }
      const localVarPath = `/members/{memberId}`.replace(
        `{${"memberId"}}`,
    ...
    getMemberSkillScoreById: async (
      ...
      if (memberId === null || memberId === undefined) {
        throw new RequiredError(
          "memberId",
          "Required parameter memberId was null or undefined when calling getMemberSkillScoreById."
        );
      }
      const localVarPath = `/members/{memberId}/skillScores`.replace(
        `{${"memberId"}}`,
        encodeURIComponent(String(memberId))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getMemberStampsById: async (
      ...
      if (memberId === null || memberId === undefined) {
        throw new RequiredError(
          "memberId",
          "Required parameter memberId was null or undefined when calling getMemberStampsById."
        );
      }
      const localVarPath = `/members/{memberId}/stamps`.replace(
        `{${"memberId"}}`,
        encodeURIComponent(String(memberId))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getMemberThreadsById: async (
      ...
      if (memberId === null || memberId === undefined) {
        throw new RequiredError(
          "memberId",
          "Required parameter memberId was null or undefined when calling getMemberThreadsById."
        );
      }
      const localVarPath = `/members/{memberId}/threads`.replace(
        `{${"memberId"}}`,
        encodeURIComponent(String(memberId))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await DefaultApiAxiosParamCreator(
        configuration
      ).getMemberById(memberId, options);
      return (
     ...
     * @throws {RequiredError}
     */
    async getMemberSkillScoreById(
      memberId: string,
      options?: any
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<SkillScore>
    > {
      const localVarAxiosArgs = await DefaultApiAxiosParamCreator(
        configuration
      ).getMemberSkillScoreById(memberId, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    > {
      const localVarAxiosArgs = await DefaultApiAxiosParamCreator(
        configuration
      ).getMemberStampsById(memberId, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
     ...
     * @throws {RequiredError}
     */
    async getMemberThreadsById(
      memberId: string,
      options?: any
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Thread>>
    > {
      const localVarAxiosArgs = await DefaultApiAxiosParamCreator(
        configuration
      ).getMemberThreadsById(memberId, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
...
export const DefaultApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    getMemberSkillScoreById(
      memberId: string,
      options?: any
    ): AxiosPromise<SkillScore> {
      return DefaultApiFp(configuration)
        .getMemberSkillScoreById(memberId, options)
        .then((request) => request(axios, basePath));
    },
